        ...
        if (response.ok) {
            ...
            switch (formData.role) {
                case 'student':
                    ...
                    window.location.href = 'http://127.0.0.1:5500/internhacks_signup/public/stuForm.html';
                    break;
                case 'recruiter':
                    console.log(formData._id);  
                    localStorage.setItem('OrganizerId',formData._id); 
                    window.location.href = 'http://127.0.0.1:5500/internhacks_signup/public/recu.html';
                    break;
                case 'organizer':
                    localStorage.setItem('OrganizerId',formData._id); 
                    window.location.href = 'http://127.0.0.1:5500/internhacks_signup/public/desevent.html';
                    break;
                default:
